...
时间 | 修改人 |  修改内容 |
--------- | --------|  --------|
2018-5-31  | fanhl |  修改mysql主键为 tablename_id  |
...
9. 【推荐】表必备三字段：tablename_id, gmt_create, gmt_modified。
**说明：** 其中 tablename_id 必为主键，类型为 **unsigned bigint** 、单表时自增、步长为 1。gmt_create, gmt_modified 的类型均为 date_time 类型。
